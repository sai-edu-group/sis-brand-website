export const sectionHeaderContent = {
  title: "Radio Orange 99.9 FM",
  subtitle:
    "Radio Orange 99.9 is an in-house virtual radio station, operated by the students under faculty supervision.",
};

export const radioorangeContent = {
  id: 1,
  content: `<p class="fade-in">Radio Orange 99.9 is an in-house virtual radio station, operated by the students under faculty supervision. It is the first School radio broad casting system in the state of Odisha and is a brilliant training ground for those students who dream of pursuing a career in broad casting. It gives them a great platform to share their thoughts and views and at the same time develop their communication skills along with unleashing their creativity.</p>
  ...
  <p class="fade-in">Radio Orange helps students to become confident, responsible, encourage team work, develop oratory skills and concepts such as professionalism, ethos, attitude etc., be creative and expand the learning horizon to keep abreast of all the recent happenings.</p>
  `,
