export const founderDetails = {
  ...
  content: `
<p class="text-orange-500">| <a class="relative w-1/2 min-w-[170px] text-lg leading-[24px] font-medium text-orange-500 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-[width] after:duration-300 hover:after:w-full md:w-fit md:text-xl" href="https://bijayaksahoo.com" target="_blank" >Website</a> | <a class="relative w-1/2 min-w-[170px] text-lg leading-[24px] font-medium text-orange-500 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-[width] after:duration-300 hover:after:w-full md:w-fit md:text-xl" href="https://en.wikipedia.org/wiki/Bijaya_Kumar_Sahoo" target="_blank" >Wikipedia</a> | <a class="relative w-1/2 min-w-[170px] text-lg leading-[24px] font-medium text-orange-500 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-[width] after:duration-300 hover:after:w-full md:w-fit md:text-xl" href="https://bijayaksahoo.com/ctbook/" target="_blank" >A Journey of Purpose</a> |</p>

<p class="fade-in">Dr Sahoo’s endeavour has always been to ensure that all the stakeholders of SAI International are happy. When he conceived the idea to start SAI International School, his sole focus was on creating a globally-benchmarked School where each and every child is happy and where learning takes place in a joyful environment. Education is the foundation on which the progress of a nation depends. It is a human right that creates profound implications on social, economic and personal development. He understood that knowledge acquisition is very important, but it is also equally vital to build character and personality. This is what SAI International follows – Holistic Parenting. The word parenting is used here as each one here, the teachers, staff and the students feel a part of one big family. He believed that strong relationships are the key to a happy life.</p>

<p class="fade-in">Dr Sahoo’s approach towards teaching-learning at SAI International was completely student-centric which is radically different from the teacher-centric approach. He made sure that we teach the importance of mindfulness to students, by helping them to inculcate the habit of paying close attention to the present moment or putting the complete focus on whatever they are doing, through closely-monitored hands-on activities.</p>

<p class="fade-in">Connect the children to the age-old values, which is the pride of our nation equipping them with the 21st-century skills to help them align their competencies and thought processes with the fast-changing global scenario. Children at SAI will learn to strengthen competencies, be creative and intuitive, become aspirational, develop commitments and values, and most importantly, imbibe positive thinking.</p>
...
<p class="fade-in">His vision of making India better through education is engraved in each brick of the school and his voice still resounds in each stakeholders ear to spread ‘happiness’ and ‘positivity’ to create a profound impact on the well-being of the students.</p>`,
};
