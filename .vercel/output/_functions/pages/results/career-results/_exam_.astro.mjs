...
import { c as careerResults } from '../../../chunks/career-results_gYZhTQrO.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { exam } = Astro2.params;
  const year = Astro2.url.searchParams.get("year");
  const classItem = careerResults.find(
    (careerResultItem) => careerResultItem.name.toLowerCase().replaceAll(" ", "-") === exam
  );
  if (!exam || !year || !classItem) {
  ...
  const breadcrumbItems = [
    { label: "Career Results", href: URLS.RESULTS.CAREER_RESULTS.ROOT },
    {
      ...
      href: `${URLS.RESULTS.CAREER_RESULTS.EXAM(exam)}?year=${year}`
    }
  ];
...
}, "/Users/abhayamin/Documents/pixolo/sis-brand-website/src/pages/results/career-results/[exam]/index.astro", void 0);

const $$file = "/Users/abhayamin/Documents/pixolo/sis-brand-website/src/pages/results/career-results/[exam]/index.astro";
const $$url = "/results/career-results/[exam]";
