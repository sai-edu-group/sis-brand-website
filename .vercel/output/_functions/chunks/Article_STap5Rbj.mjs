import { c as createComponent, a as createAstro, m as maybeRenderHead, r as renderComponent, w as Fragment, b as renderTemplate, d as addAttribute, e as renderSlot } from './astro/server_wWZRp_y9.mjs';
import { $ as $$SectionHeaderMain } from './SectionHeaderMain_BmwBqac_.mjs';
/* empty css                         */

const $$Astro$1 = createAstro();
const $$MetaStrip = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$MetaStrip;
  function timeAgo(dateInput) {
    const now = /* @__PURE__ */ new Date();
    const date2 = typeof dateInput === "number" ? new Date(dateInput * 1e3) : new Date(dateInput);
...
const $$Article = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<div class="flex flex-col gap-9"> <!-- Header Container --> <div class="flex flex-col gap-9"> ', " <!-- Meta Strip --> ", ' </div> <div class="article-root"> ', ' </div> </div>  <script>\n  document.addEventListener("DOMContentLoaded", () => {\n    const articleRoot = document.querySelector(".article-root");\n    if (!articleRoot) return;\n\n    const tables = articleRoot.querySelectorAll("table");\n\n    tables.forEach((table) => {\n      // If already wrapped, skip\n      if (table.parentElement?.classList.contains("table-wrapper")) return;\n\n      const wrapper = document.createElement("div");\n      wrapper.className = "table-wrapper overflow-x-auto";\n      table.parentNode.insertBefore(wrapper, table);\n      wrapper.appendChild(table);\n    });\n  });\n<\/script>'])), maybeRenderHead(), renderComponent($$result, "SectionHeaderMain", $$SectionHeaderMain, { "title": title, "subtitle": subtitle, "eyebrowText": eyebrowText, "ctaText": ctaText }), metaStripDetails && renderTemplate`${renderComponent($$result, "MetaStrip", $$MetaStrip, { ...metaStripDetails })}`, renderSlot($$result, $$slots["default"]));
}, "/Users/abhayamin/Documents/pixolo/sis-brand-website/src/components/Article.astro", void 0);
